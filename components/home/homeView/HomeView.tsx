...
const HomeView: React.FC = () => {
    ...
    return (
        <div className={s.container}>
            <RegisterModal isOpen={isRegisterModalOpen} close={() => setRegisterModalOpen(false)}/>
            <LoginModal isOpen={isLoginModalOpen} close={() => setLoginModalOpen(false)}/>
            <div className={s.blocksContainer}>
                ...
                <div className={s.ctaContainer}>
                    ...
                    <Button type="button" value="Créer un compte" onclick={() => setRegisterModalOpen(true)}/>
                    ...
                    <Button type="button" value="Se connecter" onclick={() => setLoginModalOpen(true)}/>
                </div>
            </div>
        </div>
    );
